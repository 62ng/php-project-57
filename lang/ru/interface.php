...
return [
    ...
    */
    ...
    'home_header' => 'Привет от Хекслета!',
    ...
    'task_header_create' => 'Создать задачу',
    'task_link_update' => 'Изменить',
    'task_link_delete' => 'Удалить',
    'task_button_update' => 'Обновить',
    'task_button_to_update' => 'Изменить задачу',
    'task_button_to_create' => 'Создать задачу',
    'task_button_create' => 'Создать',
    'task_button_filter' => 'Применить',
    'task_label_name' => 'Имя',
    'task_label_description' => 'Описание',
    'task_label_status' => 'Статус',
    'task_label_assignee' => 'Исполнитель',
    'task_label_creator' => 'Создатель',
